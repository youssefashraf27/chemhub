(function() {
    ...
    */
    ...
    function Ha() {
        var a = window;
        Array.isArray(a.GoogleDX5YKUSkRag) || (a.GoogleDX5YKUSkRag = []);
        return new q.Promise(function(b) {
            a.GoogleDX5YKUSkRag.push(b)
        })
    }
    ...
    */
    ...
    function Pa(a) {
        this.url = (this.l = a) ? "https://ep1.adtrafficquality.google/pagead/gen_204?id=sodar2&v=255" : "https://pagead2.googlesyndication.com/pagead/gen_204?id=sodar2&v=255"
    }
    ...
    function Qa(a, b, c) {
        var d = new Pa(b === void 0 ? !1 : b.l),
            f = b === void 0 || b.R !== "0";
        c !== !1 && f || (d.url = d.l ? "https://ep1.adtrafficquality.google/pagead/sodar?id=sodar2&v=255" : "https://pagead2.googlesyndication.com/pagead/sodar?id=sodar2&v=255");
        V(d, "t", a);
    ...
    function fb(a, b) {
        function c(g) {
            g && g.data !== null && g.origin === "https://www.google.com" && g.source != null && g.source === b.contentWindow && (a.h = "id=sodar2&v=255", a.config && (a.h += "&li=" + encodeURIComponent(a.config.T.toString()), a.h += "&" + (a.config.context === "cr" ? "bgai" : "jk") + "=" + encodeURIComponent(a.config.N.toString()), g.source.postMessage(JSON.stringify({
                id: "sodar",
                params: a.h
    ...
    function db(a) {
        var b, c, d;
        return J(function(f) {
            if (f.g == 1) return b = M((a.l ? "https://ep2.adtrafficquality.google/sodar/" : "https://tpc.googlesyndication.com/sodar/") + "sodar2/255/runner.html"), f.h(xa(b), 2);
            if (f.g != 4) {
                c = f.j;
